...
type inmemRepository struct {
	...
	// RWMutex protege el acceso concurrente a los maps.
	// Se debe bloquear (Lock) antes de escribir y usar un bloqueo
	// de lectura (RLock) antes de leer para evitar race conditions.
	sync.RWMutex
}
